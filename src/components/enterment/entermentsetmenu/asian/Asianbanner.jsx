...
export default function Asianbanner() {
      ...
      <div className="mainetn">
        <div className="firstetn">
          <div className="hansoetn">
            <img src="./images/entertainment/asian/movie.jpg" alt="" />
          </div>
        ...
        <div className="secetn">
          <div className="moneyheist">
            <img src="./images/entertainment/asian/movie2.jpg" alt="" />
          </div>
        ...
        <div className="thirdetn">
          <div className="jurassic">
            <img src="./images/entertainment/asian/thai.jpg" alt="" />
          </div>
