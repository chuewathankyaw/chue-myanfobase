...
export default function Myanmarbanner() {
      ...
      <div className="mainetn">
        <div className="firstetn">
          <div className="hansoetn">
            <img src="./images/entertainment/myanmar/burmese.jpg" alt="" />
          </div>
        ...
        <div className="secetn">
          <div className="moneyheist">
            <img src="./images/entertainment/myanmar/burmese2.jpg" alt="" />
          </div>
        ...
        <div className="thirdetn">
          <div className="jurassic">
            <img src="./images/entertainment/myanmar/burmese3.jpg" alt="" />
          </div>
