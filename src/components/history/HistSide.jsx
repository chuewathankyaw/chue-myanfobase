...
export default function HistSide() {
  return (
    <div className="sidebar">
      <div className="cate-main">
        <div className="postCate">
          <div className="Cate_img">
            <img src="./images/history/king1.jpg" alt="" />
            <p className="Catebutton cateHistory">History</p>
          </div>
        ...
        <div className="postCate">
          <div className="Cate_img">
            <img src="./images/history/pagoda1.jpg" alt="" />
            <p className="Catebutton cateHistory">History</p>
          </div>
          <div className="postCate_info">
            <h4>18 Top Fall Fashion Trends from New York Fashion</h4>
        ...
        <div className="postCate">
          <div className="Cate_img">
            <img src="./images/history/Rangoon_river.jpg" alt="" />
            <p className="Catebutton cateHistory">History</p>
          </div>
          <div className="postCate_info">
            <h4>18 Top Fall Fashion Trends from New York Fashion</h4>
        ...
        <div className="postCate">
          <div className="Cate_img">
            <img src="./images/history/30-Comrades.jpg" alt="" />
            <p className="Catebutton cateHistory">History</p>
          </div>
          <div className="postCate_info">
            <h4>18 Top Fall Fashion Trends from New York Fashion</h4>
